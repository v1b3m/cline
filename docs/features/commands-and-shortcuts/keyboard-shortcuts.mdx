...
| `claude-ben.SidebarProvider.focus`                                                       | Opens and focuses the Cline sidebar           |
...
| --------------------- | ------------------------------ | ----------------------------------------- | ----------------------------- |
| Open Cline Sidebar    | `Ctrl+Shift+C` / `Cmd+Shift+C` | `claude-ben.SidebarProvider.focus`        | Opens the Cline sidebar panel |
