...
export abstract class WebviewProvider {
	public static readonly sideBarId = "claude-ben.SidebarProvider" // used in package.json as the view's id. This value cannot be changed due to how vscode caches views based on their id, and updating the id would break existing instances of the extension.
	public static readonly tabPanelId = "claude-ben.TabPanelProvider"
	...
	public static getActiveInstance(): WebviewProvider | undefined {
		return Array.from(this.activeInstances).find((instance) => {
			if (
				instance.getWebview() &&
				instance.getWebview().viewType === "claude-ben.TabPanelProvider" &&
